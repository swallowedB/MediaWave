...
export default function FloatInput({
  ...
  return (
    <div className="relative w-full inline-block">
      ...
      />
      <label
        className="absolute left-3 text-white/0 text-sm transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-placeholder-shown:text-white/40 peer-focus:top-[-9px] peer-focus:text-sm peer-focus:text-blue-400 px-1 peer-focus:bg-[#211741] "
        htmlFor={id}
      >
        {label}
      </label>
